...
class _MyAccountPage extends State<MyAccount> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
            future: context.read<SupabaseHandle>().postStreamCurrentUser(),
            builder: (context, snapshot) {
              ...
              return StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      return Center(
                        child: Text("initiate your first post"),
                      );
                    }
                    ...
                    return ListView.builder(
                        itemBuilder: (context, index) {
                          ...
                          final String? postImageUrl = context
                              .read<SupabaseHandle>()
                              .postImageUrl(postImagePath);

                          final postUser = doc["created_by"];

                          final postUserPfp = context
                              .read<SupabaseHandle>()
                              .pfpUrlGiver(postUser);
